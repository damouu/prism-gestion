<template>
    <div id="ReservationFomulaireMaterielEtu">
                    ...
                    <b-card>
                        ...
                        <form>
                            <b-row align-h="end" class="mt-2">
                                <b-button variant="primary" size="lg" class="ml-2 mr-2" @click="validateNext()">Valider
                                    et continuer
                                </b-button>
                                <b-button variant="primary" size="lg" class="ml-2 mr-2" @click="validate()">Valider
                                </b-button>
                            </b-row>
                            <b-row>
                                <b-col cols="6">
                                    <b-card class="mt-4">
                                        ...
                                        <div>
                                            ...
                                            <b-form-group>
                                                ...
                                                <b-form-invalid-feedback id="invalidDateEmprunt">Veuillez écrire une
                                                    date valide.
                                                </b-form-invalid-feedback>
                                                <b-form-invalid-feedback id="invalidHeureEmprunt">Veuillez écrire une
                                                    heure valide.
                                                </b-form-invalid-feedback>
                                            </b-form-group>
                                        ...
                                        <b-row>
                                                ...
                                                <b-form-group label-cols-sm="3" label="Filtre">
                                                    <b-input-group>
                                                        ...
                                                        <b-input-group-append>
                                                            <b-button :disabled="!filter" @click="filter = ''">Annuler
                                                            </b-button>
                                                        </b-input-group-append>
                                                    </b-input-group>
                                                </b-form-group>
                                            ...
                                            <b-table
                                                ...
                                                <template slot="agenda" slot-scope="row">
                                                    <b-button variant="success" @click="agendaRow(row)"
                                                              v-b-modal.modal-AgendaModal>
                                                    ...
                                                    <b-card>
                                                        <b-table
                                                            ...
                                                            <template slot="disponibilite" slot-scope="row">
                                                                ...
                                                                <div v-else-if="!row.value.disp">
                                                                    <div v-if="row.value.etat==='réparation'">
                                                                        <h3>
                                                                            <b-badge variant="warning">Réparation
                                                                            </b-badge>
                                                                        </h3>
                                                                    </div>
                                                                    <div v-else-if="row.value.etat==='non empruntable'">
                                                                        <h3>
                                                                            <b-badge variant="secondary">Non
                                                                                empruntable
                                                                            </b-badge>
                                                                        </h3>
                                                                    </div>
                                                                    <div v-else>
                                                                        <h3>
                                                                            <b-badge variant="danger">Emprunté</b-badge>
                                                                        </h3>
                                                                    </div>
                                                            ...
                                                            <template slot="actions" slot-scope="row"
                                                                ...
                                                                <b-button variant="success" @click="agendaRow(row)"
                                                                          v-b-modal.modal-AgendaModal class="ml-1">
                                                                    <font-awesome-icon :icon="['fas','calendar-day']"/>
                                                                </b-button>
                                                            </template>
                                                        </b-table>
                                                ...
                                                <template slot="empty" slot-scope="scope">
                                                    <h6 class="text-center">Choisissez une date de sortie et une date de
                                                        retour.</h6>
                                                </template>
        ...
        <b-modal id="bv-modal-feuilleNext" ref="modalNext" hide-footer :no-close-on-backdrop="true">
            ...
            <b-button class="mt-3" size="lg" block @click="nextFeuille()">Fermer et passer à la feuille réservation
                suivante
            </b-button>
        </b-modal>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getFormulaire() {
                axios.get('https://iutnc-resamat.univ-lorraine.fr/api/reservations/' + this.formulaireId)
                    .catch(error => {
            ...
            getAll() {
                axios.get('https://iutnc-resamat.univ-lorraine.fr/api/materiels/?select=reservation')
                    .then(response => {
            ...
            rowSelected(items) {
                ...
                try {
                    ...
                    if (items[0].fiche_resa.length === 0 && !existe && (items[0].disponibilite.etat != 'emprunté' && items[0].disponibilite.etat != 'réparation')) {
                        ...
                        this.exemplaires.push({
                            id: items[0].id,
                            materiel: data.modele + data.constructeur,
                            type: data.type.nom,
            ...
            validateNext() {
                if (this.exemplaire && this.date_depart && this.date_retour) {
                    ...
                    axios.post('https://iutnc-resamat.univ-lorraine.fr/api/reservations/' + this.formulaireId + '/feuilles', {
