                            ...
                            <b-row align-h="around" class="mt-4">
                                ...
                                <b-col cols="6">
                                    ...
                                    <b-row align-h="between">
                                        <h3>Informations</h3>
                                        <b-col cols="8">
                                            <b-button variant="primary" class="mr-2" v-b-modal.modal-Materiel
                                                      @click="modalEditMateriel">Modifier
                                            </b-button>
                                            <b-button variant="outline-danger" class=" ml-2"
                                                      v-b-modal.modal-DeleteMateriel @click="modalDeleteMateriel">
                                                Supprimer matériel
                                            </b-button>
                                        </b-col>
                                    </b-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getMateriel() {
                axios.get('https://iutnc-resamat.univ-lorraine.fr/api/materiels/' + this.materielId)
                    .then(response => {
                        this.materiel = response.data.materiel;
                        this.materielType = {
                            'value': response.data.materiel.type.id,
                            'text': response.data.materiel.type.nom
                        };
                        this.loading = false;
                    })
                    .catch(error => {
