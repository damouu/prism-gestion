...
class FournisseurController extends Controller
{
    ...
    public function put(Request $request, Response $response, $args)
    {
        ...
        if(empty($id) || !isset($content['nom']) || !isset($content['adresse']) || !isset($content['ville']) || !isset($content['code_postal']) || !isset($content['mail']) || !isset($content['tel'])){
            $data = ApiErrors::BadRequest();
        }
        else
        {
            try{
                ...
                else
                {
                    ...
                    if(isset($content['commercial_nom']))
                    {
                        $fournisseur->commercial_nom = $content['commercial_nom'];
                    };

                    if(isset($content['commercial_prenom']))
                    {
                        $fournisseur->commercial_prenom = $content['commercial_prenom'];
                    };

                    if(isset($content['commercial_tel']))
                    {
                        $fournisseur->commercial_tel = $content['commercial_tel'];
                    };

                    if(isset($content['commercial_mail']))
                    {
                        $fournisseur->commercial_mail = $content['commercial_mail'];
                    };
