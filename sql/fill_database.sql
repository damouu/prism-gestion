...
INSERT INTO `departement` (`nom`) VALUES ('MMI');
INSERT INTO `departement` (`nom`) VALUES ('TECH DE CO');
...
INSERT INTO `reservation` (`responsable_projet`,`departement`,`matiere`,`projet`,`referent`,`date_depart`,`date_retour`,`observation`) VALUES (1,1,'test matiere','le projet du génie',1,'1997-03-15 08:23:24','2019-05-21 12:30:12');